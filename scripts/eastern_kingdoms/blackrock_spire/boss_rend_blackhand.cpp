...
static uint32 auiWave[8][5] =
{
    ...
    {NPC_CHROMATIC_DRAGONSPAWN, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, 0},
    {NPC_CHROMATIC_DRAGONSPAWN, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_BLACKHAND_DRAGON_HANDLER, 0},
    {NPC_CHROMATIC_DRAGONSPAWN, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_BLACKHAND_DRAGON_HANDLER, 0},
    {NPC_CHROMATIC_DRAGONSPAWN, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_BLACKHAND_DRAGON_HANDLER},
    {NPC_CHROMATIC_DRAGONSPAWN, NPC_CHROMATIC_DRAGONSPAWN, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_BLACKHAND_DRAGON_HANDLER},
    {NPC_CHROMATIC_DRAGONSPAWN, NPC_CHROMATIC_DRAGONSPAWN, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_BLACKHAND_DRAGON_HANDLER},
    {NPC_GYTH, 0, 0, 0, 0}
};

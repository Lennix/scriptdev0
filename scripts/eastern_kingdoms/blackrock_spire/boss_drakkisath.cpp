...
SD%Complete: 100
SDComment: With scripts support for Chromatic Elite Guard
...
struct MANGOS_DLL_DECL boss_drakkisathAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        if (m_uiConflagrationTimer <= uiDiff)
        {
            ...
            m_uiConflagrationTimer = urand(10000,12000);
        }
        else
        ...
        if (m_uiFlamestrikeTimer <= uiDiff)
        {
            ...
            m_uiFlamestrikeTimer = urand(7000,9000);
        }
        else
        ...
        if (m_uiThunderclapTimer <= uiDiff)
        {
            ...
            m_uiThunderclapTimer = urand(10000,15000);
        }
        else

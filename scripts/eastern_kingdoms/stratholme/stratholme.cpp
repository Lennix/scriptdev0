...
bool GOUse_go_blacksmithing_plans(Player* pPlayer, GameObject* pGo)
{
    ...
    switch(pGo->GetEntry())
    {
        ...
        case 176327:        // Undead Stratholme side, Summon "Black Guard Swordsmith"
            ...
            break;
        default:
            error_log("SD0: Stratholme: Script for gameobject \"Blacksmithing Plans\" used by another object, than should be! GUID: %s ENTRY: %u", pGo->GetObjectGuid(), pGo->GetEntry());
    }

...
struct MANGOS_DLL_DECL boss_captain_kromcrushAI : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        m_uiRetaliationTimer = urand(5000,6000);
    }
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        // Spawn adds at 66% health
        if (!m_bIsSpawned && HealthBelowPct(66))
        {
        ...
        if (m_uiFrighteningShoutTimer <= uiDiff)
        {
            ...
            m_uiFrighteningShoutTimer = urand(10000,15000);
        }
        else
        ...
        if (m_uiMortalCleaveTimer <= uiDiff)
        {
            ...
            m_uiMortalCleaveTimer = urand(6000,8000);
        }
        else
